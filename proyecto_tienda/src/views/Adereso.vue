<template>
  <div>
    ...
    <div class="container">
      <div class="row">
        <div v-for="(mayo,index) of mayonesa" :key="index" class="col-md-6">
    ...
    <div class="container">
      <div class="row">
        <div v-for="(a,index) of ketchup" :key="index" class="col-md-6">
          <b-card no-body class="overflow-hidden efc" style="max-width: 540px;">
            <b-row no-gutters>
              <b-col md="6">
    ...
    <div class="container">
      <div class="row">
        <div v-for="(moz,index) of mostaza" :key="index" class="col-md-6">
          <b-card no-body class="overflow-hidden efc" style="max-width: 540px;">
            <b-row no-gutters>
              <b-col md="6">
