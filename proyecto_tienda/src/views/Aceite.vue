      ...
      <div class="row">
        <div v-for="(f,index) of fino" :key="index" class="col-md-6">
          <b-card no-body class="overflow-hidden efc" style="max-width: 540px;">
            <b-row no-gutters>
              <b-col md="6">
                <b-card-img v-bind:src="require('../assets/aceite/'+f.portada)" style="padding:10px" class="rounded-circle"></b-card-img>
              </b-col>
              <b-col md="6">
    ...
    <center>
      <div class="container" v-for="(a,index) of agranel" :key="index">
        <b-card no-body class="overflow-hidden efc" style="max-width: 540px;">
          <b-row no-gutters>
            <b-col md="6">
              <b-card-img v-bind:src="require('../assets/aceite/'+a.portada)" style="padding:10px" class="rounded-circle"></b-card-img>
            </b-col>
            <b-col md="6">
